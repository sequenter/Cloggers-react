import { type MouseEvent, type ReactNode, forwardRef, useImperativeHandle, useState } from 'react';
...
export const Dialog = forwardRef<DialogHandle, Props>(({ children, controls, icon, title, onClose }: Props, ref) => {
