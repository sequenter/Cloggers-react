...
import { PlayerDialog, type PlayerDialogHandle } from '@components/dialog/PlayerDialog';
...
const Header = () => {
  ...
  const dialog = useRef<PlayerDialogHandle>(null);
          ...
          <div className="flex items-center justify-between container mx-auto px-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <IconButton
                ...
                disabled={!Object.keys(playerRecords).length}
                path={gnomeIcon}
